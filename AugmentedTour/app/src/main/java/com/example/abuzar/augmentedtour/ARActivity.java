...
public class ARActivity extends AppCompatActivity implements SensorEventListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  String n  = extras.getString("name");
       ...
       // String longg = extras.getString("longg");
       // String alti = extras.getString("alti");


       // String [][] stringArray = intent.getStringArrayExtra("Points");
      //  String[][] passedString_list = (String[][]) mBundle.getSerializable("list");



        String[][] arrayReceived=null;
        Object[] objectArray = (Object[]) getIntent().getExtras().getSerializable("pointslist");
        if(objectArray!=null){
         ...
         int range=Integer.parseInt(getIntent().getStringExtra("range"));
        ...
        arOverlayView = new AROverlayView(this,arrayReceived,range);
    }
